...
import img3 from "../../static/img/shop-details/product-big-3.png"
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg={img1}>
                                    <img   style={{ width: "80px" , height:"110px",  backgroundColor: '#ffffff'}}  src={img1} alt=""/>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg={img2}>
                                    <img  style={{ width: "80px" , height:"110px",  backgroundColor: '#ffffff'}}  src={img2} alt=""/>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg={img3}>
                                    <img   style={{ width: "80px" , height:"110px",  backgroundColor: '#ffffff'}}   src={img3} alt="" />
                                    </div>
                                </a>
                            </li>
                            {/* <li class="nav-item">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img class='product__details__pic__item' src={img2} alt=""/>
                                </div>
                            </div>
                            {/* <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img class='product__details__pic__item' src={img3} alt=""/>
                                </div>
                            </div>
